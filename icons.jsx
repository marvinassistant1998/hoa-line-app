...
export const Icons = {
  // 導航用
  home: ({ className = "w-6 h-6", color = "currentColor", filled = false }) => (
    <svg className={className} viewBox="0 0 24 24" fill={filled ? color : "none"}>
      <path d="M3 10.5L12 3l9 7.5V20a1 1 0 01-1 1h-5v-6a1 1 0 00-1-1h-4a1 1 0 00-1 1v6H4a1 1 0 01-1-1v-9.5z" stroke={filled ? "none" : color} strokeWidth="1.5"/>
    </svg>
  ),
  users: ({ className = "w-6 h-6", color = "currentColor", filled = false }) => (
    <svg className={className} viewBox="0 0 24 24" fill={filled ? color : "none"}>
  ...
  building: ({ className = "w-6 h-6", color = "currentColor", filled = false }) => (
  ...
  settings: ({ className = "w-6 h-6", color = "currentColor", filled = false }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none">
      <circle cx="12" cy="12" r="3" stroke={color} strokeWidth="1.5"/>
      <path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83 0 2 2 0 010-2.83l.06-.06a1.65 1.65 0 00.33-1.82 1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 010-2.83 2 2 0 012.83 0l.06.06a1.65 1.65 0 001.82.33H9a1.65 1.65 0 001-1.51V3a2 2 0 114 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 0 2 2 0 010 2.83l-.06.06a1.65 1.65 0 00-.33 1.82V9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z" stroke={color} strokeWidth="1.5"/>
    </svg>
  ),

  // 通用操作
  chevronLeft: ({ className = "w-6 h-6", color = "currentColor" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none">
      <path d="M15 19l-7-7 7-7" stroke={color} strokeWidth="2" strokeLinecap="round"/>
    </svg>
  ),
  chevronRight: ({ className = "w-6 h-6", color = "currentColor" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none">
  ...
  x: ({ className = "w-6 h-6", color = "currentColor" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none">
  ...
  edit: ({ className = "w-6 h-6", color = "currentColor" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none">
  ...
  trash: ({ className = "w-6 h-6", color = "currentColor" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none">
  ...
  phone: ({ className = "w-6 h-6", color = "currentColor" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none">
      <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.13.96.36 1.9.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0122 16.92z" stroke={color} strokeWidth="1.5"/>
    </svg>
  ),
  wrench: ({ className = "w-6 h-6", color = "currentColor" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none">
  ...
  dollarSign: ({ className = "w-6 h-6", color = "currentColor" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none">
  ...
  clipboard: ({ className = "w-6 h-6", color = "currentColor" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none">
  ...
  alertCircle: ({ className = "w-6 h-6", color = "currentColor" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none">
      <circle cx="12" cy="12" r="10" stroke={color} strokeWidth="1.5"/>
  ...
  camera: ({ className = "w-6 h-6", color = "currentColor" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none">
  ...
  upload: ({ className = "w-6 h-6", color = "currentColor" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none">
  ...
  image: ({ className = "w-6 h-6", color = "currentColor" }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none">
  ...
  // LINE 圖示
  line: ({ className = "w-6 h-6", color = "currentColor" }) => (
